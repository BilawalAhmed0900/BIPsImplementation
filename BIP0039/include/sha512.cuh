...
#define LL_ROTLEFT(a,b) (((a) << (b)) | ((a) >> (64ll-(b))))
#define LL_ROTRIGHT(a,b) (((a) >> (b)) | ((a) << (64ll-(b))))

#define LL_CH(x,y,z) (((x) & (y)) ^ (~(x) & (z)))
#define LL_MAJ(x,y,z) (((x) & (y)) ^ ((x) & (z)) ^ ((y) & (z)))

#define S0(a) ((LL_ROTRIGHT((a), 28ll)) ^ (LL_ROTRIGHT((a), 34ll)) ^ (LL_ROTRIGHT((a), 39ll)))
#define S1(e) ((LL_ROTRIGHT((e), 14ll)) ^ (LL_ROTRIGHT((e), 18ll)) ^ (LL_ROTRIGHT((e), 41ll)))
#define s0(a) ((LL_ROTRIGHT((a), 1ll)) ^ (LL_ROTRIGHT((a), 8ll)) ^ ((a) >> 7ll))
#define s1(e) ((LL_ROTRIGHT((e), 19ll)) ^ (LL_ROTRIGHT((e), 61ll)) ^ ((e) >> 6ll))
